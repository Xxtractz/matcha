...
class Profiles extends Component {
  constructor(props) {
    ...
    this.state = {
      cards: [
        ...
        },
        {
          ...
          phone: "(475) 388-0086",
          about:
              "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Curabitur sed tortor. Integer aliquam adipiscing lacus. Ut nec urna et arcu imperdiet",
        },
        {
          name: "Holmes",
          age: 24,
          phone: "(408) 516-7207",
          about:
              "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Curabitur sed tortor. Integer aliquam adipiscing lacus. Ut nec urna et arcu imperdiet ullamcorper.",
        },
        {
          name: "Nathaniel",
          age: 19,
    ...
    getUsers(getUserGenderPreference());
  }
    ...
    return (
      <div>
        <Card variant="outlined" style={{ height: "620px", width: "320px" }}>
          <CardHeader title={user.name} subheader={user.age} />
          <CardMedia
